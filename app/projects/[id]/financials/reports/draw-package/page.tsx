...
export default function BankPackageGenerator() {
  ...
  const loadDrawData = async (targetDraw: any) => {
    ...
    // 2. Fetch the Master Draw Summary (Pulls the exact math generated by the SQL Trigger)
  ...
  return (
    <div className="w-full bg-slate-950 min-h-screen p-6 md:p-12 text-slate-100 pb-32">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10">
        ...
        <div className="bg-slate-900 border border-slate-800 p-8 rounded-[32px]">
          <p className="text-[10px] font-black text-slate-500 uppercase tracking-widest mb-2"><ShieldCheck size={14} className="inline mr-1 text-emerald-500"/> Retainage / Holdback</p>
